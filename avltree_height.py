...
data = pd.read_csv('height_vs_nodes_avl.csv', header=None,low_memory=False, encoding="utf-8-sig",  delimiter=',')
...
plotly.offline.plot({"data": [go.Scatter(x=nodes, y=height)],
                    "layout": go.Layout(title="AVL Tree Height VS Nodes")}, auto_open=True)