...
data = pd.read_csv('rbtree_performance.csv', header=None,low_memory=False, encoding="utf-8-sig",  delimiter=',')
...
data = pd.read_csv('avltree_performance.csv', header=None,low_memory=False, encoding="utf-8-sig",  delimiter=',')
